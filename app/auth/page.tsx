          ...
          <div className="bg-surface-dark border border-border-color rounded-xl shadow-2xl overflow-hidden backdrop-blur-xl">
            ...
            <div className="px-6 sm:px-8 mt-4">
              <div className="flex border-b border-slate-700 justify-between relative">
                <button onClick={() => setVariant("LOGIN")} className={`flex flex-col items-center justify-center pb-3 pt-2 flex-1 cursor-pointer transition-colors text-sm font-bold tracking-[0.015em] border-b-2 ${variant === "LOGIN" ? "border-primary text-white" : "border-transparent text-slate-500 hover:text-white"}`}>Sign In</button>
                <button onClick={() => setVariant("REGISTER")} className={`flex flex-col items-center justify-center pb-3 pt-2 flex-1 cursor-pointer transition-colors text-sm font-bold tracking-[0.015em] border-b-2 ${variant === "REGISTER" ? "border-primary text-white" : "border-transparent text-slate-500 hover:text-white"}`}>Sign Up</button>
              </div>
            </div>
            ...
            <div className="p-6 sm:p-8 flex flex-col gap-5">
              ...
              <div className="flex flex-col sm:flex-row gap-3">
                <button 
                  ...
                  className="flex-1 h-12 p-3 flex items-center justify-center gap-2 bg-surface-highlight hover:bg-[#323644] text-white rounded-lg border border-slate-700 transition-all duration-200"
                >
                ...
                {/* <button 
                  ...
                  className="flex-1 h-12 flex items-center justify-center gap-2 bg-surface-highlight hover:bg-[#323644] text-white rounded-lg border border-slate-700 transition-all duration-200"
                >
              ...
              <div className="relative flex py-2 items-center">
                <div className="flex border-t border-slate-700"></div>
                <span className="shrink mx-4 text-xs font-semibold text-slate-500 uppercase">Or continue with email</span>
                <div className="flex border-t border-slate-700"></div>
              </div>
              ...
              <form onSubmit={handleSubmit} className="flex flex-col gap-4">
                {variant === "REGISTER" && (
                  <label className="flex flex-col gap-2">
                    ...
                    <div className="flex items-center gap-3 bg-surface-highlight border border-slate-700 rounded-xl px-4 h-12 focus-within:border-primary focus-within:ring-1 focus-within:ring-primary transition-all">
                      <span className="material-symbols-outlined text-slate-500 text-[20px]">person</span>
                      <input required disabled className="bg-transparent border-none text-white placeholder-slate-500 focus:ring-0 w-full p-0 text-sm outline-none" placeholder="John Doe" type="text"/>
                    </div>
                  </label>
                )}
                <label className="flex flex-col gap-2">
                  ...
                  <div className="flex items-center gap-3 bg-surface-highlight border border-slate-700 rounded-xl px-4 h-12 focus-within:border-primary focus-within:ring-1 focus-within:ring-primary transition-all">
                    ...
                    <input required disabled className="bg-transparent border-none text-white placeholder-slate-500 focus:ring-0 w-full p-0 text-sm outline-none" placeholder="Enter your email" type="email"/>
                  </div>
                </label>
                <label className="flex flex-col gap-2">
                  ...
                  <div className="flex items-center gap-3 bg-surface-highlight border border-slate-700 rounded-xl px-4 h-12 focus-within:border-primary focus-within:ring-1 focus-within:ring-primary transition-all">
                    ...
                    <input required disabled className="bg-transparent border-none text-white placeholder-slate-500 focus:ring-0 w-full p-0 text-sm outline-none" placeholder="Enter your password" type="password"/>
                  </div>
                </label>
                <button 
                  type="submit"
